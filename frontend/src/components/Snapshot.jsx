...
import logo from '../images/etsc-logo.png'
...
if (typeof window !== 'undefined') {
  ...
  if (typeof web3 !== 'undefined') {
    ...
    web3 = new Web3(Web3.givenProvider || "https://node.ethereumsocial.kr")
  }
}
    ...
    return (
      <div className="App-Container">
        <div className="App">
          ...
          <p className="App-intro">This is the Ethereum Social Snapshot system for mainnet</p>
          ...
          {this.state.message ? <p className="App-message">Your Ethereum Social Balance is: {this.state.message} ETSC</p> : null}
          {this.state.error ? <p className="App-error">{this.state.error}</p> : null}
        </div>
        <footer className="Footer" key="footer">
          <a
            href="https://github.com/ethereumsocial/ETSC-Snapshot"
            target="_blank"
